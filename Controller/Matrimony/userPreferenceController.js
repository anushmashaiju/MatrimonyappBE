...
const createPartnerPreference = async (req, res) => {
    try {
        ...
        const id = userId; // Assuming userId is extracted from authenticated user
...
const getCurrentPartnerPreferenceByUserId = async (req, res) => {
    try {
...
module.exports = {createPartnerPreference,getPartnerPreferenceByUserId,getCurrentPartnerPreferenceByUserId }